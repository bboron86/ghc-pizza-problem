...
const readline = require('linebyline'), rl = readline(`./app/resources/${_file}.in`);
...
function findAllPossibleSlices(r, c) {
  ...
  coordinates.forEach(elem => {
    for (var _r = r; _r < elem.r; _r++) {
      for (var _c = c; i < elem.c; _c++) {
